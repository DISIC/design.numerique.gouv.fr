...
Pour contrôler la présence de l’attribut `alt` et son contenu, faire un clic droit sur l’image puis sélectionner &laquo;&nbsp;inspecter&nbsp;&raquo; : le bout de code concerné s’affiche alors.
