<template>
  <div class="fr-grid-row fr-grid-row--center">
    <div class="dg-message dg-text-center fr-col-lg-10 fr-mx-2w fr-py-3w fr-px-6w">
      ...
      <g-link class="fr-link fr-fi-arrow-right-line fr-link--icon-right" to="/articles/2021-10-29-formations-design-accessibilite-recherche-ecoconception/">
