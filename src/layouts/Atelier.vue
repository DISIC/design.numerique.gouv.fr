          ...
          <div class="fr-header__body-row">
            <div class="fr-header__brand fr-enlarge-link">
              ...
              <div class="fr-header__service">
                <a class="fr-header__service-title text-highlight" href="./"
                  >Déclaration de bicyclette</a
                >
              </div>
            </div>
            <div class="fr-header__tools">
              <div class="fr-header__tools-links">
                <p class="fr-links-group">
                  <a
                    class="fr-link fr-fi-mail-line"
                    href="/atelier-a11y/contact/"
                  ></a>
                </p>
              </div>
            </div>
          ...
          >
            <ul id="nav" class="fr-nav__list">
              ...
              <li class="fr-nav__item">
                <a
                  class="fr-nav__link"
                  href="/atelier-a11y/declarer-ma-bicyclette/"
                  >Déclarer ma bicyclette</a
                >
              </li>
              <li class="fr-nav__item">
      ...
      <div class="fr-container">
        <div class="footer fr-footer__body fr-footer__body--operator">
          <div class="fr-footer__brand">
            <p class="fr-logo">Les ateliers de <br /><span>DesignGouv</span></p>
          </div>
          ...
          <ul class="fr-footer__bottom-list">
            <li class="fr-footer__bottom-item">
              <a
                ...
                href="/atelier-a11y/plan-du-site/"
                >Plan du site</a
              >
            </li>
            <li class="fr-footer__bottom-item">
              <a
                class="fr-footer__bottom-link"
                href="/atelier-a11y/accessibilite/"
