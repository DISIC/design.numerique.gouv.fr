    ...
    <div class="dg-content dg-content--sm fr-px-2w">
      <div class="fr-mb-6w">
        ...
        <p>
          ...
          administrations pour rendre <strong>plus accessibles</strong>,
          <strong>plus simples</strong> et
          <strong>plus compréhensibles</strong> leurs services en ligne.
        </p>
        <p class="fr-mb-2w">Nos expertes sont spécialisées en :</p>
        <ul class="team fr-mb-4w">
          <li class="dg-text-with-picto fr-mb-1w">
            <span class="dg-picto dg-picto--xs fr-mr-3v"
              ><font-awesome
                :icon="['fas', 'comments']"
                width="12px"
                height="12px"
      ...
      <div class="fr-mb-6w">
        ...
        <ol class="fr-mb-2w">
          ...
          <li class="dg-text-with-picto fr-mb-1w">
            ...
            <strong
              >Nous construisons ensemble un accompagnement sur-mesure</strong
            >
          </li>
          <li class="dg-text-with-picto fr-mb-1w">
        ...
        <g-link
          to="/accompagnement/obtenir-un-accompagnement/"
          class="fr-btn fr-fi-arrow-right-line fr-btn--icon-right fr-mb-2w"
        >
      ...
      <div>
        ...
        <ul class="missions">
          <li
            v-for="{ node } in presentAccompagnements"
            :key="node.id"
            class="mission fr-px-md-2w fr-pt-1w fr-py-md-2v"
          >
            <div class="mission__left">
              <h3 class="mission__name">
                <g-link :to="'/accompagnement/' + $slugify(node.name)">{{
                  node.name
                }}</g-link>
              </h3>
            </div>
            <div class="mission__right">
              <ul class="mission__team fr-pt-md-1v">
                <li v-for="expert in node.experts" :key="expert">
                  <g-image
                    class="mission__team-member fr-ml-3v"
                    :src="findPhoto(expert).photo"
                    :alt="expert"
                  />
                </li>
              </ul>
              <p
                class="fr-badge fr-badge--sm fr-badge--info fr-badge--no-icon fr-ml-md-2w"
              >
                En cours
              </p>
            </div>
          ...
          <li
            v-for="{ node } in pastAccompagnements"
            :key="node.id"
            class="mission fr-px-md-2w fr-pt-1w fr-py-md-2v"
          >
            <div class="mission__left">
            ...
            <div class="mission__right">
              ...
              <p
                class="fr-badge fr-badge--sm fr-badge--success fr-badge--no-icon fr-ml-md-2w"
              >
                Terminé
              </p>
            </div>
          ...
          <li
            v-for="{ node } in $page.missions.edges"
            :key="node.id"
            class="mission fr-px-md-2w fr-pt-2w fr-py-md-2v"
          >
            <div class="mission__left">
              <h3 class="mission__name">
                <g-link :to="'/accompagnement/commando-ux/' + node.slug">{{
                  node.title
                }}</g-link>
              </h3>
            </div>
            <div class="mission__right">
              <ul class="mission__team fr-pt-md-1w">
                <li v-for="member in node.team" :key="member.id">
                  <g-image
                    class="mission__team-member fr-ml-3v"
                    :src="member.photo"
    ...
    meta: [
      {
        name: "description",
        content:
          "Vous souhaitez rendre votre site accessible, faire des tests avec des usagers ou avoir une vraie approche design pour votre service mais vous ne savez pas comment faire ? Nous sommes là pour vous aider !",
      },
      {
        property: "og:title",
