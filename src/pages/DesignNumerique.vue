            ...
            <ul class="dg-list-no-decoration">
              <li class="fr-mb-4w">
                ...
                <p class="fr-mb-2w">
                  ...
                  pour tester l’adéquation entre un service numérique et ces
                  besoins et attentes. Pour cela, plusieurs méthodes existent
                  comme les enquêtes, les entretiens utilisateurs et les tests
                  utilisateurs.
                </p>
                <a
              ...
              <li class="fr-mb-2w">
                ...
                <p>
                  ...
                  différents cas d’usage et toute l’expérience du service. Pour
              ...
              <li class="fr-mb-4w">
                ...
                <a
                  ...
                  title="Le système de design de l’État - Nouvelle fenêtre"
                  target="_blank"
                  class="fr-btn fr-btn--secondary fr-btn--sm fr-fi-arrow-right-line fr-btn--icon-right"
              ...
              <li class="fr-mb-2w">
                ...
                <p>
                  ...
                  <a
                    href="https://www.iso.org/fr/standard/78907.html"
                    title="Langage clair - Nouvelle fenêtre"
                    target="_blank"
                    >langage clair</a
                  >, du
                  <a
                    href="https://www.unapei.org/article/de-nouvelles-fiches-en-facile-a-lire-et-a-comprendre-falc-realisees-par-la-cnsa/"
                    title="Facile À Lire et à Comprendre (FALC) - Nouvelle fenêtre"
                    target="_blank"
                ...
                <div class="fr-card__content">
                  <h3 class="fr-card__title fr-h6">
                    <a
                      href="https://designgouv.notion.site/La-recherche-utilisateur-27f77d6e829a4187817be6f91398a78e?pvs=4"
                      target="_blank"
                      title="La recherche utilisateur - Nouvelle fenêtre"
                      class="dg-link--no-icon"
                      >La recherche utilisateur</a
                    >
                  </h3>
                  ...
                  <p class="fr-card__desc">
                    Découvrez la recherche utilisateur et les ressources pour
                    vous aider à la mettre en œuvre.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="fr-card__content">
                  <h3 class="fr-card__title fr-h6">
                    <a
                      href="https://designgouv.notion.site/Fiches-de-poste-832419ace6ac4514831ac2f43fe23401?pvs=4"
                      target="_blank"
                      title="Les fiches de poste - Nouvelle fenêtre"
                      class="dg-link--no-icon"
                      >Les fiches de poste</a
                    >
                  </h3>
                  <div class="fr-card__start">
                    <ul class="fr-badges-group">
                  ...
                  <p class="fr-card__desc">
                    Consultez nos fiches de postes pour vous aider dans vos
                    recrutements.
                  </p>
                </div>
              </div>
            ...
            <div class="fr-card fr-enlarge-link">
              <div class="fr-card__body">
                <div class="fr-card__content">
                  ...
                  <p class="fr-card__desc">
                    Estimez de manière
                    <strong>partielle et rapide</strong> l’accessibilité de
                    votre produit ou service numérique.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="fr-card fr-enlarge-link">
              <div class="fr-card__body">
                <div class="fr-card__content">
                  <h3 class="fr-card__title fr-h6">
                    <a href="/outils/#tests"
                      >Nos testeurs en situation de handicap</a
                    >
                  </h3>
                  <div class="fr-card__start">
                    <ul class="fr-badges-group">
            ...
            <div class="fr-card fr-enlarge-link">
              <div class="fr-card__body">
                <div class="fr-card__content">
                  ...
                  <p class="fr-card__desc">
                    Développez vos sites en utilisant des composants prêts à
                    l’emploi, accessibles et ergonomiques.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="fr-card__content">
                  <h3 class="fr-card__title fr-h6">
                    <a
                      ...
                      target="_blank"
                      title="Le bouton Je Donne Mon Avis - Nouvelle fenêtre"
                      class="dg-link--no-icon"
                      >Le bouton Je Donne Mon Avis</a
                    >
                  </h3>
                  <div class="fr-card__start">
                    <ul class="fr-badges-group">
                  ...
                  <p class="fr-card__desc">
                    Suivez en temps réel la satisfaction des usagers de vos
                  ...
                  <div class="fr-card__content">
                    <div class="fr-card__start">
                      <ul class="fr-badges-group">
                        <li>
                          <p
                            class="fr-badge fr-badge--sm fr-badge--pink-macaron"
                          >
                            {{ node.type }}
                          </p>
                        </li>
