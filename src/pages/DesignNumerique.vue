    ...
    <section class="dg-cover dg-cover--linear fr-mb-6w">
      <div class="dg-cover__container fr-mb-1w">
        ...
        <ul class="fr-tags-group">
          ...
          <li>
              <a href="#formations" class="fr-tag" target="_self">Formations</a>
          </li>
          <li>
              <a href="#articles" class="fr-tag" target="_self">Articles</a>
          </li>
      </ul>
      </div>
    </section>
        ...
        <p>Le design numérique concerne l’ensemble des pratiques permettant la
          ...
          <ul class="dg-list-no-decoration fr-pl-0">
            <li class="fr-mt-2w">
              ...
              <span class="dg-display-block fr-pl-2w">Qui apportent une solution adaptée à un besoin concret, qui soient utilisables et simples à utiliser.</span>
            </li>
            <li class="fr-mt-2w">
              <span class="fr-badge fr-badge--sm fr-badge--green-tilleul-verveine fr-mb-1v">Inclusifs</span>
              <span class="dg-display-block fr-pl-2w">Qui prennent en compte les usagers dans leur diversité comme les situations de handicap, les disparités d’aisance avec l’usage du numérique, les diversités d’équipements et d’accès au réseau.</span>
            </li>
            <li class="fr-mt-2w">
            ...
            <li class="fr-mt-2w">
              ...
              <span class="dg-display-block fr-pl-2w">Qui garantissent l’autonomie des citoyennes et citoyens dans leurs démarches, et de bonnes relations entre eux et les administrations.</span>
            </li>
            <li class="fr-mt-2w">
              <span class="fr-badge fr-badge--sm fr-badge--green-tilleul-verveine fr-mb-1v">Soutenables</span>
        ...
        <section class="fr-accordion">
          ...
          <div class="fr-collapse" id="accordion-113">
            ...
            <ul class="dg-list-no-decoration">
              <li class="fr-mb-4w">
                <h4 class="fr-h6 fr-mb-2w">La recherche utilisateur (<span lang="en">user research</span>)</h4>
                ...
                <a href="https://designgouv.notion.site/La-recherche-utilisateur-27f77d6e829a4187817be6f91398a78e?pvs=4" target="_blank" title="La recherche utilisateur en détails - Nouvelle fenêtre" class="fr-btn fr-btn--secondary fr-btn--sm fr-fi-arrow-right-line fr-btn--icon-right">La recherche utilisateur en détails</a>
              </li>
              <li class="fr-mb-2w">
                <h4 class="fr-h6 fr-mb-2w">Le design d’expérience (<span lang="en">UX design</span>)</h4>
              ...
              <li class="fr-mb-4w">
                <h4 class="fr-h6 fr-mb-2w">Le design d’interface (<span lang="en">UI design</span>)</h4>
              ...
              <li class="fr-mb-2w">
                <h4 class="fr-h6 fr-mb-2w">Le design de contenu (<span lang="en">content design</span>)</h4>
                  ...
                  <div class="fr-card fr-enlarge-link">
                      <div class="fr-card__body">
                          <div class="fr-card__content">
                              ...
                              <p class="fr-card__desc">Consultez nos fiches de postes pour vous aider dans vos recrutements.</p>
                          </div>
                      </div>
                  </div>
              </li>
                  ...
                  <div class="fr-card fr-enlarge-link">
                      <div class="fr-card__body">
                          <div class="fr-card__content">
                              ...
                              <p class="fr-card__desc">Développez vos sites en utilisant des composants prêts à l’emploi, accessibles et ergonomiques.</p>
                          </div>
                      </div>
                  </div>
              </li>
                  ...
                  <div class="fr-card fr-enlarge-link">
                      <div class="fr-card__body">
                          <div class="fr-card__content">
                              ...
                              <p class="fr-card__desc">Suivez en temps réel la satisfaction des usagers de vos services publics numériques.</p>
                          </div>
                      </div>
                  </div>
              </li>
