          ...
          <div class="fr-collapse" id="accordion-3">
            <ul class="fr-my-2w">
              ...
              <li><a href="https://mentor.gouv.fr/catalog/2825"  title="Découvrir les impacts environnementaux du numérique  - Nouvelle fenêtre" target="_blank" rel="noreferrer noopener">Découvrir les impacts environnementaux du numérique – <span lang="en">Serious Game</span></a>
                <ul><li>Organisme de formation : <strong>Direction interministérielle du numérique - Mission Numérique Écoresponsable</strong></li><li>Durée : 50min</li><li>Réservé aux agents de l’État ayant accès à la<a title="plateforme Mentor - Nouvelle fenêtre" target="_blank" rel="noreferrer noopener" href="https://mentor.gouv.fr/login/index.php">plateforme Mentor</a> jusqu'au 22/09/2025</li></ul>
              </li>    
