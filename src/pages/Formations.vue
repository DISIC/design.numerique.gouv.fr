      ...
      <div class="dg-cover__container fr-mb-1w">
        ...
        <h1 class="dg-cover__title">
          <img
            ...
            svg-inline
            src="../assets/images/formation-picto.svg"
            aria-hidden="true"
          />Formations
        </h1>
    ...
    <div class="dg-content dg-content--lg">
            ...
            <div class="fr-tile fr-enlarge-link">
              <div class="fr-tile__body">
                <div class="fr-tile__content">
                  <h2 class="fr-tile__title">
                    <g-link
                      :to="'/formations/' + node.slug + '/'"
                      class="fr-tile__link fr-text--lg"
                      >{{ node.nom }}</g-link
                    >
                  </h2>
                  <p class="fr-badge fr-badge--sm">
                    {{ node.cours.filter((cours) => cours.publier).length }}
                    {{
                      node.cours.filter((cours) => cours.publier).length > 1
                        ? "formations"
                        : "formation"
                    }}
                  </p>
              ...
              <div class="fr-tile__header">
                <div class="fr-tile__img dg-picto dg-picto--rotate">
                  ...
                  />
                  <img
                    v-else-if="node.slug == 'accessibilite'"
                    svg-inline
                  ...
                  />
                  <img
                    v-if="node.slug == 'recherche-utilisateur'"
                    svg-inline
                    src="'../assets/images/recherche-utilisateur-picto.svg'"
                    class="fr-responsive-img"
                    aria-hidden="true"
                  />
                  <img
                    v-else-if="node.slug == 'ecoconception'"
                    svg-inline
                    src="'../assets/images/ecoconception-picto.svg'"
                    class="fr-responsive-img"
                    aria-hidden="true"
                  />
                  <img
                    v-else-if="node.slug == 'simplification-information'"
                    svg-inline
                    src="'../assets/images/simplification-information-picto.svg'"
                    class="fr-responsive-img"
                    aria-hidden="true"
                  />
                </div>
      ...
      <section id="formations" class="dg-block fr-mt-8w">
        <div class="dg-content fr-px-2w fr-pt-6w fr-pb-1w">
          ...
          <div
            class="fr-grid-row fr-grid-row--gutters fr-mb-6w"
            aria-live="polite"
          >
            <div
              v-for="{ node } in filterCours"
              :key="node.id"
              class="fr-col-12 fr-col-sm-4"
            >
                ...
                <div class="fr-card__body">
                  <div class="fr-card__content">
                    ...
                    <div class="fr-card__start">
                      <p
                        v-show="
                          futurCours.filter((element) => element == node.id)
                            .length > 0
                        "
                        class="dg-flex-start fr-badge fr-badge--sm fr-badge--new fr-my-1w"
                      >
                      ...
                      <p
                        v-show="
                          futurCours.filter((element) => element == node.id)
                            .length == 0 && node.replay
                        "
                        class="dg-flex-start fr-badge fr-badge--sm fr-my-1w"
                      >
                        Replay disponible
                      </p>
                    </div>
            ...
            <div
              v-show="filterCours.length == 0"
              class="info fr-mt-1w fr-col-12"
            >
      ...
      <section class="dg-content dg-contains-list fr-mt-8w fr-px-2w">
        ...
        <p>
          Si vous travaillez dans le numérique public, il existe en ligne des
          formations vous permettant de vous former de manière autonome à
          l’amélioration des services en ligne. La liste ci-dessous répond à
          plusieurs critères :
        </p>
        <ul>
          ...
          <li>
            gratuité (ou financement de la Direction interministérielle du
            numérique - Dinum).
          </li>
        </ul>
        <p>
          Cette liste n’est pas exhaustive. Elle concerne le design des services
          numériques, l’accessibilité numérique et le numérique
          responsable/écoconception.
        </p>
        ...
        <section class="fr-accordion">
          ...
          <div class="fr-collapse" id="accordion-1">
            <ul class="fr-my-2w">
              <li>
                <a
                  href="https://openclassrooms.com/fr/courses/3013836-initiez-vous-au-design-thinking"
                  title="Initiez-vous au Design - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >Initiez-vous au Design</a
                >
                <ul>
                  <li>
                    Organisme de formation : <strong>OpenClassrooms</strong>
                  </li>
                  <li>Durée : <strong>6h</strong></li>
                </ul>
              </li>
              <li>
                <a
                  href="https://openclassrooms.com/fr/courses/3013856-ux-design-decouvrez-les-fondamentaux"
                  title="UX design : découvrez les fondamentaux - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >UX design&nbsp;: découvrez les fondamentaux</a
                >
                <ul>
                  <li>
                    Organisme de formation : <strong>OpenClassrooms</strong>
                  </li>
                  <li>Durée : <strong>8h</strong></li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div class="fr-collapse" id="accordion-2">
            <ul class="fr-my-2w">
              <!--li>
                ...
                <ul>
                  <li>
                    Organisme de formation : <strong>Inria</strong> (Institut
                    national de recherche en sciences et technologies du
                    numérique), France Université numérique
                  </li>
              ...
              <li>
                <a
                  ...
                  title="Mise en œuvre de l’accessibilité numérique - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >Mise en œuvre de l’accessibilité numérique</a
                >
                <ul>
                  <li>Organisme de formation : <strong>Wikiversité</strong></li>
                  <li>Durée : <strong>14h</strong></li>
                  <li>
                    La formation fait référence à la précédente version du
                    Référentiel général d’amélioration de l’accessibilité (RGAA)
                    mais garde toute sa pertinence.
                  </li>
                </ul>
              </li>
              <li>
                <a
                  href="https://mentor.gouv.fr/catalog/314"
                  title="L’accessibilité numérique selon votre métier - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                ...
                <ul>
                  <li>
                    Organisme de formation : <strong>Atalan</strong> (licence
                    d’utilisation accordée au Service d’information du
                    Gouvernement)
                  </li>
                  <li>
                    Durée : <strong>1h20 à 8h</strong> suivant les modules
                    choisis
                  </li>
                  <li>
                    Réservé aux agents de l’État ayant accès à la
                    <a
                      href="https://mentor.gouv.fr/login/index.php"
                      title="plateforme Mentor - Nouvelle fenêtre"
                      target="_blank"
                      rel="noreferrer noopener"
                      >plateforme Mentor</a
                    >.
              ...
              <li>
                <a
                  href="https://mentor.gouv.fr/catalog/262"
                  title="L’essentiel de l’accessibilité de la communication de l’État - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >L’essentiel de l’accessibilité de la communication de
                  l’État</a
                >
                <ul>
                  <li>
                    Organisme de formation :
                    <strong>Services du Premier Ministre</strong>
                  </li>
                  <li>Durée : <strong>3h30</strong></li>
                  <li>
                    Réservé aux agents de l’État ayant accès à la
                    <a
                      href="https://mentor.gouv.fr/login/index.php"
              ...
              <li>
                <a
                  href="https://mentor.gouv.fr/local/catalog/pages/training.php?trainingid=1405"
                  title="L’accessibilité numérique des sites et applications web : Game of code- Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >L’accessibilité numérique des sites et applications web :
                  <span lang="en">Game of code</span></a
                >
                <ul>
                  <li>
                    Organisme de formation :
                    <strong
                      >Centre Interministériel des Services Informatiques
                      relatifs aux Ressources Humaines</strong
                    >
                  </li>
                  ...
                  <li>
                    ...
                    <a
                      ...
                      >plateforme Mentor</a
                    >
                    ou ayant accès aux formations de l’Institut de la gestion
                    publique et du développement économique (IGPDE) (<a
                      href="https://catalogue.igpde.finances.gouv.fr/1528-laccessibilite-numerique-des-sites-et-applications-web-game-of-code.html?search_query=accessibilite&results=6"
                      >catalogue.igpde.finances.gouv.fr</a
                    >).
                  </li>
                </ul>
              </li>
        ...
        <section class="fr-accordion">
          ...
          <div class="fr-collapse" id="accordion-3">
            <ul class="fr-my-2w">
              <li>
                <a
                  href="https://mentor.gouv.fr/catalog/3087"
                  title="L’impact environnemental du numérique : comment agir ? - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >L’impact environnemental du numérique : comment agir ?</a
                >
                <ul>
                  <li>
                    Organisme de formation :
                    <strong
                      >Direction interministérielle du numérique - Mission
                      Numérique Écoresponsable</strong
                    >
                  </li>
              ...
              <li>
                <a
                  href="https://mentor.gouv.fr/catalog/2825"
                  title="Découvrir les impacts environnementaux du numérique  - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >Découvrir les impacts environnementaux du numérique –
                  <span lang="en">Serious Game</span></a
                >
                <ul>
                  <li>
                    Organisme de formation :
              ...
              <li>
                <a
                  href="https://www.fun-mooc.fr/fr/cours/impacts-environnementaux-du-numerique/"
                  title="Les impacts environnementaux du numérique - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >Les impacts environnementaux du numérique</a
                >
                <ul>
                  <li>
                    Organisme de formation : <strong>Inria</strong> (Institut
        ...
        <section class="fr-accordion">
          ...
          <div class="fr-collapse" id="accordion-4">
            <ul class="fr-my-2w">
              <li>
                <a
                  href="https://www.opquast.com/certification/"
                  title="Certification Qualité web - Nouvelle fenêtre"
                  target="_blank"
                  rel="noreferrer noopener"
                  >Certification Qualité web</a
                >
                <ul>
        ...
        <p class="fr-mt-8w fr-pr-1w">
          Vous pouvez aussi consulter et partager les vidéos de sensibilisation
          à l’accessibilité numérique sur
          <a
            href="https://www.youtube.com/playlist?list=PLzwHdQWfGYgaOs3drhozCyHWW4pVO4Skw"
            title="youtube - Nouvelle fenêtre"
            target="_blank"
            rel="noreferrer noopener"
            >YouTube</a
          >, également visibles <strong>et</strong> téléchargeables sur
          <a
            href="https://tube.numerique.gouv.fr/c/designgouv/videos?s=1"
...
export default {
  ...
  computed: {
    sortedFormations: function () {
      return this.$page.allFormation.edges
        .filter((formation) => formation.node.publier)
      ...
      if (someTypes || someTags) {
        return this.$page.allCours.edges
          .filter((edge) => {
            ...
            else if (!someTypes && someTags)
              return testTag && edge.node.publier;
            else return testType && testTag && edge.node.publier;
          })
          .sort((a, b) => a.node.rang - b.node.rang);
      } else {
        return this.$page.allCours.edges
          .filter((cours) => cours.node.publier)
          .sort((a, b) => a.node.rang - b.node.rang);
      }
    },
    futurCours: function () {
