    ...
    <div class="content">
      ...
      <section>
        ...
        <ul>
          ...
          <li>les <a href="/accessibilite-numerique/roles-cles/">fiches métiers</a> décrivent votre rôle, vos actions et vos outils ;</li>
      ...
      <section>
        ...
        <ul>
          <li>L’<strong>assistant RGAA</strong> facilite la réalisation d’audit en mettant à disposition les critères et tests du RGAA 4.1 directement dans le navigateur. Disponible sur <a href="https://addons.mozilla.org/fr/firefox/addon/assistant-rgaa/" target="_blank" title="assistant RGAA pour firefox - nouvelle fenêtre">firefox</a> et <a href="https://chrome.google.com/webstore/detail/assistant-rgaa/cgpmofepeeiaaljkcclfldhaalfpcand?hl=fr" target="_blank" title="assistant RGAA pour chrome - nouvelle fenêtre">chrome</a> ;</li>
