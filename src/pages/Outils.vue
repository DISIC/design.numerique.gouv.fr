  ...
  <Layout>
    ...
    <div class="cover">
     <div class="coverContainer">
      ...
      <p class="subtitle">De nombreux outils peuvent vous aider à améliorer la qualité de vos démarches vous-même. Utilisabilité, accessibilité, protection des données personnelles, bonnes pratiques, laissez vous guider.</p>
