    ...
    <div class="dg-cover dg-cover--linear fr-mb-6w">
      <div class="dg-cover__container fr-mb-1w">
        ...
        <p>
          ...
          <g-link to="/recrutement/">Consulter les postes ouverts.</g-link>
        </p>
      </div>
    </div>
    ...
    <div class="dg-content fr-px-0 fr-px-md-2w">
      <section class="fr-mb-8w">
        ...
        <p>
          ...
          d’informations et services pour tous et toutes, partout. Néanmoins,
          les produits et services numériques sont encore trop souvent conçus
          sans prendre en compte les personnes qu’ils servent. C’est le cas pour
        ...
        <p>
          Depuis septembre 2020, nous avons mis en place des
        ...
        <p>
          Nous participons à la diffusion d’une culture de design inclusif au
          sein de l’État et à la mise en communauté de compétences de design
      ...
      <section class="fr-mb-8w">
        ...
        <ul class="dg-team">
          <li v-for="{ node } in team" :key="node.id" class="dg-team-member">
            ...
            />
            <h3 class="dg-team-member__name fr-h6 fr-mb-1w">
