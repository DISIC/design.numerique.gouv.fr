  ...
  <Layout>
    ...
    <div class="content">
      ...
      <section>
        ...
        <p>Voici un exemple de déclaration d’accessibilité <a href="https://www.numerique.gouv.fr/uploads/rgaa/rgaa4-2019-exemple-declaration.pdf" title="Exemple de déclaration d'accessibilité au format pdf - nouvelle fenêtre" target="_blank" rel="noreferrer noopener">au format pdf</a> ou <a href="/outils/exemple/" title="Exemple de déclaration d'accessibilité au format html">au format html</a>.</p>
      </section>
      <section>
