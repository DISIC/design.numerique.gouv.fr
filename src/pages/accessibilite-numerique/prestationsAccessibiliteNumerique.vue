    ...
    <div class="dg-content fr-px-2w">
      ...
      <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
        <ol class="fr-breadcrumb__list">
          ...
          <li>
            <span aria-current="page" class="fr-breadcrumb__link">Prestations accessibilité numérique</span>
          </li>
        </ol>
      </nav>
      ...
      <section>
        <h2 id="accord-cadre">Les prestations de l’accord cadre</h2>
        <p>Pour rappel, le précédent accord-cadre contenait deux lots : « accompagnement et audit » et « formations ».</p>
        <h3 id="lot-1">Lot 1 : accompagnement et audit</h3>
        ...
        <h4>Les prestations d’accompagnement</h4>
        <ul>
        ...
        <h3 id="lot-2">Lot 2 : formations</h3>
...
<script>
  export default {
    metaInfo: {
      ...
      {
        property: 'og:title',
        content: "Prestations accessibilité numérique - DesignGouv"
      },
      {
