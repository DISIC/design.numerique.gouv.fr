      ...
      <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center">
        <div class="fr-col-md-6">
          <form id="declaVelo" action="/atelier-a11y/merci/">
            ...
            <div class="fr-input-group">
              <label class="fr-label" for="bike-date"
                >Date d’acquisition du vélo</label
              >
              <span class="fr-hint-text">Exemple : 02/08/1982</span>
              <input
                class="fr-input"
                type="date"
                id="bike-date"
            ...
            <div class="fr-input-group fr-form-group">
              <fieldset class="fr-fieldset">
                <legend class="fr-label fr-mb-2w">Type de vélo</legend>
            ...
            <div class="fr-input-group fr-checkbox-group">
              ...
              <label class="fr-label" for="robot"
                >Décochez la case, si vous êtes une vraie personne.
                <span class="fr-hint-text"
                  >Vous êtes un robot ? N’y touchez pas ! Merci.</span
                ></label
              >
            </div>
            <div class="fr-input-group fr-select-group">
              ...
              <select class="fr-select" id="because" name="because">
                <option value="" selected disabled hidden>
                  Selectionnez une seule option (ouais, c’est balèze)
                </option>
            ...
            <div id="btn" class="fr-btn">Valider</div>
          </form>
        </div>
      </div>
    </section>
