<template>
  <Layout>
    ...
    <section class="dg-content">
          ...
          <div class="fr-notice__body">
            <p>
              ...
              <span class="fr-notice__desc"
                ...
                faîtes appel aux experts de ces métiers !</span
              >
            </p>
            <button
      ...
      <div>
        <p class="fr-mb-0">
          <strong>Légende des expertises mobilisées :</strong>
        </p>
        <ul class="dg-list-no-decoration">
          <li>
            <span class="fr-ml-4w fr-badge fr-badge--sm fr-badge--pink-macaron"
              >design</span
            >
            : designer, designer UX/UI ou designer produit
          </li>
          <li>
            <span class="fr-ml-4w fr-badge fr-badge--sm fr-badge--pink-macaron"
              ...
              <h2 class="fr-accordion__title">
                ...
                >
                  <span class="dg-text-with-picto">
                    <strong class="dg-picto dg-picto--xs fr-mr-3v">{{
                      node.order
                    }}</strong>
                    {{ node.title }}
                    <span
