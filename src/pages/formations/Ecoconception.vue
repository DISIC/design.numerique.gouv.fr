  ...
  <div class="content fr-container">
    <div class="fr-grid-row fr-grid-row--center">
        <div class="fr-col-12 fr-col-md-8">
          ...
          <p>La formation a eu lieu en direct le jeudi 16 décembre. Vous pouvez la revivre <a href="https://www.youtube.com/watch?v=qaPFSK-Jbxg" target="_blank" title="sur notre chaîne YouTube - Nouvelle fenêtre">sur notre chaîne YouTube</a>.</p>
