    ...
    <div class="dg-content fr-px-2w">
      ...
      <section>
        <h2>Déclaration d’accessibilité</h2>
         <p>
           Le site design.numerique.gouv.fr est développé selon les recommandations du référentiel général d’amélioration de l’accessibilité (RGAA) pour être accessible à tous les usagers quel que soit le matériel ou le logiciel utilisé pour naviguer sur internet.
         </p>
