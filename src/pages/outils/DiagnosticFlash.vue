    ...
    <div class="rf-accordion rf-callout guide">
      ...
      <div class="rf-collapse" id="rf-accordion-0">
        <div class="rf-accordion__inner">
          ...
          <p>Le résultat peut être saisi dans <a href="/assets/doc/diagnostic-flash.ods" title="le tableur dédié (format ods - 43Ko) - nouvelle fenêtre" target="_blank">le tableurtarget="_blank" rel="noreferrer noopener"ods - 43Ko)</a> qui délivre une note.</p>
