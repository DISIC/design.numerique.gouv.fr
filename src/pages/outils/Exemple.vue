...
<ul>
  <li>Schéma pluriannuel de mise en accessibilité 2020-2022 <span class="tofill">[url]</span></li>
<li>Actions réalisées en 2019-2020 <span class="tofill">[url]</span></li>
<li>Plan d’actions 2020-2021 <span class="tofill">[url]</span></li>
</ul>
<p>Cette déclaration d’accessibilité s’applique à <span class="tofill">[www.nomdusite.gouv.fr]</span>.</p>
...
<p>L’audit de conformité réalisé par <span class="tofill">[nom de l’entité qui a réalisé l’audit]</span> révèle que :</p>
<ul>
<li><span class="tofill">[nn%]</span> des critères du RGAA version 4 sont respectés</li>
<li>[Facultatif] Le taux moyen de conformité du site s’élève à <span class="tofill">[nn%]</span></li>
<li>[Facultatif] Accès à la grille d’audit RGAA <span class="tofill">[url pour télécharger la grille d’audit]</span></li>
</ul>
...
sur cette démarche, vous pouvez contacter le NN NN NN NN NN. La version 2020 respectera les
...
[https://www.defenseurdesdroits.fr/saisir/delegues]</li>
